...
<table border="1" width="50%" style="border-collapse: collapse;">
  <form action="modules/quanlysanpham/xuly.php?idsanpham=<?php echo $row['idsanpham'] ?>" method="post" enctype="multipart/form-data">
    ...
    <tr>
      <td>Tóm tắt</td>
      <td><textarea rows="5" name="tomtat" style="resize: none" value=""><?php echo $row['tomtat'] ?></textarea> </td>
    </tr>
    <tr>
      <td>Nội dung</td>
      <td> <textarea rows="5" name="noidung" style="resize: none" value=""><?php echo $row['noidung'] ?></textarea> </td>
    </tr>
    <tr>
