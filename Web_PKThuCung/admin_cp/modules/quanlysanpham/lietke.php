...
<table border="1" width="50%" style="border-collapse: collapse;">
  ...
  <tr>
    ...
    ?></td>
    <td>
      <a href="modules/quanlysanpham/xuly.php?idsanpham=<?php echo $row['id_sanpham'] ?>">Xoá</a> | <a href="?action=quanlysanpham&query=edit&idsanpham=<?php echo $row['id_sanpham'] ?>">Sửa</a>
    </td>
  </tr>
<?php } ?>
</table>
